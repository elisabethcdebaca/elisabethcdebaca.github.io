...
export var wallSound = new soundFile("CougarGrowlpong.mp3"); //load sound 
...
export var adventureMusic = new soundFile("catrave.mp3");
soundArray.push(adventureMusic);
adventureMusic.player.loop = true;
adventureMusic.player.volume.value = -10;

//undo this later unless it works//export var villageMusic = new soundFile("Eight_Bit_Village_Loop.mp3");
//soundArray.push(villageMusic);
//villageMusic.player.loop = true;
//villageMusic.player.volume.value = -16;

 export var villageMusic = new soundFile("catrave.mp3");
soundArray.push(villageMusic);
villageMusic.player.loop = true;
